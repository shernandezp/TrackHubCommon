...
{
    /// <summary>
    /// Returns the account's lifecycle status, or <c>null</c> when it cannot be resolved.
    /// </summary>
    Task<AccountStatus?> GetStatusAsync(Guid accountId, CancellationToken cancellationToken);
}
